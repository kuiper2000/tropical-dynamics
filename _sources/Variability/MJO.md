...
## Theory for MJO
There are two main theories for MJO: (1) wave dynamics and (2) moisture mode framework. Each of them satisfy different threshold. For wave dynamics, the tendency associated with gravity/Rossby wave is non-neglegible. i.e., 
