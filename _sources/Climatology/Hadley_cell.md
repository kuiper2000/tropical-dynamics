...
For example, if there is more energy input into the box within the region of $0^{\circ}$ and $35^{\circ}N$ than $0^{\circ}$ and $35^{\circ}S$. Then the Hadley circulation should transport more energy from the Northern hemisphere subtropics to the Southern hemisphere subtropics. (i.e., {numref}`FIG3-3`)
